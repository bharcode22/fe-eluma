...
export const PropertyCard = memo(({ property, currentIndex, isFavorite, onPrev, onNext, onFavorite, priceView, setPriceView, getCurrencySymbol, convertPrice, currency, exchangeRates }) => {
  return (
