...
const ContactUs = ({ id }) => {
  ...
  return (
    <div className="bg-base-100 rounded-3xl p-6 border border-base-300 shadow-sm space-y-6">
      ...
      {/* Quick Inquiry Form */}
      <div className="pt-2 border-t border-base-200 space-y-4">
        ...
        {sentSuccess && (
          <div className="p-3 rounded-xl bg-success/10 border border-success/20 text-success text-xs font-medium flex items-center gap-2">
            ...
            <span>Inquiry sent successfully! Our agent will contact you soon.</span>
          </div>
        )}
        ...
        <form onSubmit={handleInquirySubmit} className="space-y-3">
          <div className="space-y-1">
            <input
              ...
              className="input input-sm input-bordered w-full rounded-xl bg-base-100 text-xs focus:outline-none focus:border-primary"
            />
          </div>
          ...
          <div className="space-y-1">
            <textarea
              ...
              className="textarea textarea-sm textarea-bordered w-full rounded-xl bg-base-100 text-xs focus:outline-none focus:border-primary"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={sending}
            className="btn btn-primary btn-sm w-full rounded-xl text-white font-bold gap-2 text-xs shadow-md"
          >
            {sending ? (
              <>
