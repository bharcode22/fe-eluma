...
export default function ServiceCard({
    ...
    return (
        <div className="group bg-base-100 rounded-2xl border border-base-300 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col justify-between">
