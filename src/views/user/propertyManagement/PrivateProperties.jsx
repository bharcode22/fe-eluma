...
const PrivateProperties = ({ properties, ...props }) => {
  if (properties.length === 0) {
    return (
      <div className="text-center py-16 space-y-4">
        ...
        <h3 className="text-xl font-semibold text-base-content">No Private Properties</h3>
        <p className="text-base-content/70">No private properties found.</p>
